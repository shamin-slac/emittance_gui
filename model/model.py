    ...
    def quadscan(self, emit_params):
        class EmittanceMeasurementResult:
            ...
            def __init__(self):
                ...
                self.twiss = [np.array([[4.45227821, -0.08799274, 0.22634316],
                ...
                self.rms_beamsizes = [np.array([2.11004182e2, 1.61777833e2, 1.14536742e2,
                                                7.24512720e1, 4.95130807e1, 6.79336517e1,
                                                1.52933266e2, 1.99458518e2, 2.46393640e2]),
